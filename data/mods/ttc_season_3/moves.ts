export const Moves: {[k: string]: ModdedMoveData} = {
	...
	defog: {
		...
		onHit(target, source, move) {
			...
			const removeTarget = [
				'reflect', 'lightscreen', 'auroraveil', 'flowerveil',
				'safeguard', 'mist', 'spikes', 'toxicspikes', 'stealthrock',
	...
	courtchange: {
		...
		onHitField(target, source) {
			const sideConditions = [
				...
				'auroraveil', 'gmaxsteelsurge', 'gmaxcannonade',
				'gmaxvinelash', 'gmaxwildfire', 'flowerveil'
			];
