export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	kirayami: {
		...
		types: ["Dark"],
		gender: "N",
		baseStats: {hp: 125, atk: 100, def: 70, spa: 115, spd: 70, spe: 100},
		abilities: {0: "Berserk", H: "Supreme Hatred"},
		heightm: 1.96,
		weightkg: 192,
		color: "Black",
		eggGroups: ["Undiscovered"],
	...
	dienen: {
		...
		types: ["Psychic"],
		gender: "N",
		baseStats: {hp: 75, atk: 55, def: 65, spa: 125, spd: 120, spe: 140},
		abilities: {0: "Forewarn", H: "Perfect Sync"},
		heightm: 2.08,
		weightkg: 185,
		color: "Pink",
		eggGroups: ["Undiscovered"],
